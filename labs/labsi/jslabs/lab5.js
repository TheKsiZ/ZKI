...
    document.getElementById('output').innerHTML = '<table><tr><td>' + leftTableView + '</td> <td><div class="line1"></div></td> <td>' + middleTableView + '</td><td><div class="line1"></div></td><td>' + rightTableView + '</td></tr></table>'; 
    document.getElementById('outputLine').innerText = ((action=='encrypt')?'Шифровка':'Дешифровка')+': '+resultLine;
}
btnDelete.addEventListener('click', function(){
    document.getElementById('outputLine').style.display = "none"
    document.getElementById('output').style.display = "none"
    document.getElementById('colsKey').value = ""
    document.getElementById('rowsKey').value = ""
...
let aboba = document.getElementById('method')
aboba.addEventListener('click', function(){
    if(aboba.selectedIndex == 2){
