...
//stroki, stolbci
let deword = document.getElementById('deword');
let btnDecode = document.getElementById('decode');
let deresult = document.getElementById('deresultword');
...
btnDeleteMagic.addEventListener('click', function () {
    TextToWork = magicText.value;
    result1.value = DeleteMagic(TextToWork);
})
